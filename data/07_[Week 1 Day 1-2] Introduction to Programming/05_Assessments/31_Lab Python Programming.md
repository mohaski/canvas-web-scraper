...
## ![](https://moringa.instructure.com/courses/1391/files/620140/preview?) Lab: Python Programming
...
1. 1. Prompt the user for inputs:
...
1. 1. Run your script and test it with various inputs to ensure it works correctly
...
1. Review your code to ensure it meets all requirements outlined in the lab instructions and the rubric below.
2. When you're satisfied with your solution, submit your completed `pizza_order_cost.py` script using one of the following methods:
   * + Text file
     + File upload
...
Original URL: https://moringa.instructure.com/courses/1391/modules/items/239140

Scraped At: 2026-05-14T15:18:40.240483
