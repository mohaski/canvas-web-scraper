...
## ![](https://moringa.instructure.com/courses/1406/files/625387/preview) Technical Lesson Part 1: Filtering Data with SQL
...
For this part of the lesson, we'll use the Northwind database.

Use the `data.sqlite` file with the Python notebook `SQLM2P1.ipynb` in the **[Drive


Links to an external site.](https://drive.google.com/drive/folders/1a1CMVmU1e46DcuosXgr21f2f8VgDPC0T)**.

The ERD (Entity Relationship Diagram) of which is shown below:

[![DS-C1M1-Tech-Lesson-Database-Diagram](https://moringa.instructure.com/courses/1406/files/625324/download)](https://moringa.instructure.com/courses/1406/files/625324/download "DS-C1M1-Tech-Lesson-Database-Diagram")

Below, we connect to a SQLite database using the Python sqlite3 library ([documentation here


Links to an external site.](https://docs.python.org/3/library/sqlite3.html)), then display the contents of the employees table:
...
### [Step 1: Selecting Employees Based on String Conditions](#dpPanel0)
...
| # | employeeNumber | lastName | firstName | extension | email | officeCode | reportsTo | jobTitle | first\_initial |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**Important note:** Just like in Python, you can compare numbers in SQL just by typing the number (e.g. name\_length = 5) but if you want to compare to a string value, you need to surround the value with quotes (e.g. first\_initial = "L"). If you forget the quotes, you will get an error, because SQL will interpret it as a variable name rather than a hard-coded value:
...
### [Step 2: Selecting Order Details Based on Price](#dpPanel1)
...
| --- | --- | --- | --- | --- | --- | --- |
| 0 | 10104 | S24\_2840 | 44 | 30.41 | 10 | 30 |
| 1 | 10173 | S24\_1937 | 31 | 29.87 | 9 | 30 |
| 2 | 10184 | S24\_2840 | 42 | 30.06 | 7 | 30 |
| 3 | 10280 | S24\_1937 | 20 | 29.87 | 12 | 30 |
| 4 | 10332 | S24\_1937 | 45 | 29.87 | 6 | 30 |
| 5 | 10367 | S24\_1937 | 23 | 29.54 | 13 | 30 |
| 6 | 10380 | S24\_1937 | 32 | 29.87 | 4 | 30 |

### [Step 3: Selecting Orders Based on Date](#dpPanel2)
...
| 12 | 10215 | 2004-01-29 | 2004-02-08 | 2004-02-01 | Shipped | Customer requested that FedEx Ground is used f... | 475 | 01 |
...
| # | orderNumber | orderDate | requiredDate | shippedDate | status | comments | customerNumber | days\_late |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Original URL: https://moringa.instructure.com/courses/1406/modules/items/243707

Scraped At: 2026-05-14T21:09:02.072852
