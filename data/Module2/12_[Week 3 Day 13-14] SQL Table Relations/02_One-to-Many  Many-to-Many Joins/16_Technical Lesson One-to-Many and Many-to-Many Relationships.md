...
## ![](https://moringa.instructure.com/courses/1406/files/625387/preview) Technical Lesson: One-to-Many and Many-to-Many Relationships
...
![ERD of eight tables from previous modules.](https://moringa.instructure.com/courses/1406/files/625425/download)
...
The video below will guide you through each step of the lesson. You can follow along with this video to walk through each step, refer to the written instructions provided below the video, or use both resources for a comprehensive understanding of one-to-many and many-to-many relationships.

[VIDEO LINK](https://player.vimeo.com/video/1001740545?h=476f07ad43)

### Instructions

#### Step 1: Connecting to the Database

Use the `data.sqlite` file with the Python notebook `SQLM3P2.ipynb` in the **[Drive
...
| --- | --- | --- | --- |
Sales Rep Employee Data Output
...
Original URL: https://moringa.instructure.com/courses/1406/modules/items/243780

Scraped At: 2026-05-14T21:13:36.633356
